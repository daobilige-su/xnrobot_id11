syms mu_x mu_y mu_theta lm_x lm_y lm_theta lm_idp real
...
expectedZ = atan2((lm_y_coord-mu(2)),(lm_x_coord-mu(1))) - mu(3);
...
A = jacobian(expectedZ,[mu_x mu_y mu_theta lm_x lm_y lm_theta lm_idp]);
