function [mu, sigma, observedLandmarks,init_bearing] = correction_step_2d(mu, sigma, z, observedLandmarks,init_depth,obs_std,init_bearing)
...
for i = 1:m
    ...
    if(observedLandmarks(landmarkId)==false)
        ...
        mu(3+4*(landmarkId-1)+3) = mu(3);%wrapToPi(z(i).bearing+mu(3));
        init_bearing(landmarkId) = z(i).bearing;
