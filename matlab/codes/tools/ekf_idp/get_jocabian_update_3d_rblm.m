syms mu_x mu_y mu_z mu_qr mu_qx mu_qy mu_qz lm_x lm_y lm_z real
...
l_local = [M_x(1:3,1:3)',-M_x(1:3,1:3)'*M_x(1:3,4);0,0,0,1]*[lm;1];
Z = [sqrt(sum(l_local(1:3).^2));atan2(l_local(2),l_local(1));atan2(l_local(3),sqrt(l_local(1)^2+l_local(2)^2))];
