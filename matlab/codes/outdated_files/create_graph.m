...
c3d_x_gt_ypr = [reshape(ss_pos',size(ss_pos,1)*3,1);reshape(robot_pose',size(robot_pose,1)*6,1)];
...
c3d_x_gt_quat = [reshape(ss_pos',size(ss_pos,1)*3,1);reshape(robot_pose_quat',size(robot_pose_quat,1)*7,1)];
