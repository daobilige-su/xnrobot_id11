...
figure(1);
plot_graph_ini_3d(g3d, 0, plot_ini_obs_on);
%plot_graph(g, i);
...
for i = 1:numIterations
  ...
  figure(2);
  plot_graph_3d(g3d, i,H, plot_obs_on);
...
lm_3d_xy_coord = zeros(g3d.ss_num,3);
for n=1:g3d.ss_num
  lm_3d_xy_coord(n,:) = (g3d.x(g3d.ss_num*3+7*(g3d.lm_ini_pose_correspondance_3d(n,2)-1)+1:g3d.ss_num*3+7*(g3d.lm_ini_pose_correspondance_3d(n,2)-1)+3) + ...
    (1/g3d.x(3*(n-1)+3))*[cos(g3d.x(3*(n-1)+2))*cos(g3d.x(3*(n-1)+1));cos(g3d.x(3*(n-1)+2))*sin(g3d.x(3*(n-1)+1));sin(g3d.x(3*(n-1)+2))])';
end

lm_3d_xy_coord_gt = zeros(g3d.ss_num,3);
for n=1:g3d.ss_num
  lm_3d_xy_coord_gt(n,:) = (g3d.x_gt(g3d.ss_num*3+7*(g3d.lm_ini_pose_correspondance_3d(n,2)-1)+1:g3d.ss_num*3+7*(g3d.lm_ini_pose_correspondance_3d(n,2)-1)+3) + ...
    (1/g3d.x_gt(3*(n-1)+3))*[cos(g3d.x_gt(3*(n-1)+2))*cos(g3d.x_gt(3*(n-1)+1));cos(g3d.x_gt(3*(n-1)+2))*sin(g3d.x_gt(3*(n-1)+1));sin(g3d.x_gt(3*(n-1)+2))])';
end
